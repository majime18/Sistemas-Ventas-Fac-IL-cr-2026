...
if($_POST){
 $pdo->prepare("INSERT INTO roles (empresa_id,nombre,estado) VALUES (?,?,1)")
     ->execute([$_SESSION['empresa_id'],$_POST['nombre']]);
 header("Location: roles.php"); exit;
}
?>
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Nuevo Rol</title><style>
...
<body><div class="container"><div class="h1">Nuevo Rol</div>
